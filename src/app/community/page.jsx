...
export default function CommunityPage() {
  ...
  // Fix: Get communities array from the correct path
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <p className="text-red-600 text-lg font-semibold mb-2">Gagal memuat komunitas</p>
      ...
      <section className="relative w-full h-screen flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-8 leading-relaxed">
            Bergabunglah dengan komunitas petani untuk berbagi pengetahuan dan pengalaman
          </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div className="flex items-center gap-8 mb-4 sm:mb-0">
            ...
            {profile?.data && (
              <Link href="/community/my" className="text-xl font-medium text-gray-500 hover:text-green-600 transition-colors">
                My Community
              </Link>
            )}
          </div>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {filteredCommunities.map((community) => {
                ...
                return (
                  <Card key={community.id} className="group overflow-hidden rounded-2xl border-0 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    <div className="relative h-52 w-full overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4 flex flex-col gap-2">
                        <Badge variant="secondary" className="bg-white/95 text-gray-700 font-medium px-3 py-1.5 text-xs rounded-full shadow-lg backdrop-blur-sm">
                    ...
                    <CardFooter className="flex gap-3 pt-3 border-t border-gray-100">
                      <Link href={`/community/${community.id}`} className="flex-1">
                        <Button variant="outline" className="w-full rounded-full border-gray-300 hover:border-green-500 hover:text-green-600 transition-all duration-200">
                          Lihat Detail
                        </Button>
                      </Link>
